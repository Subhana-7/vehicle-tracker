...
export const TripTable = ({ logs }: TripTableProps) => (
...
export const TripItem = ({
  ...
  <>
    {/* Desktop / Tablet */}
    <div
      className={`hidden sm:flex items-center justify-between px-4 py-2.5 border-b border-gray-100 hover:bg-gray-50 transition cursor-pointer ${
    ...
    {/* Mobile */}
    <div
      className={`flex sm:hidden items-center justify-between px-3 py-3.5 border-b border-gray-100 hover:bg-gray-50 transition ${
        isFirst ? "border-t border-gray-100" : ""
      }`}
    >
